...
void ofApp::draw(){
    ...
    for(int x=0; x<10; x++){
        for(int y=0; y<10; y++){
            ...
            ofSetColor(0, 0, 255);
            ofCircle(x*widthStep, y*heightStep, resultDim_pan);
            ofSetColor(0);
            ofCircle(x*widthStep, y*heightStep, resultDim_tilt/2);
        }
    }
    ...
    ofSetColor(0, 0, 255);
    ofFill();
    ofCircle(mouseX, mouseY, resultDim_pan);
    ofSetColor(0);
    ofCircle(mouseX, mouseY, resultDim_tilt/2);
